...
namespace Model
{
    public class Character : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _canShootMechanics =
                new CanShootMechanics(Attack.CanAttack, BulletsData.Count, AttackCooldownTimer.Finished);
            _ammoMechanics = new AmmoMechanics(Attack, BulletsData.Count, AttackCooldownTimer.Finished);
            _shootMechanics = new ShootMechanics(Attack, FirePoint, BulletPrefab, transform);
        }
